...
RUST_LOG=proof::mpc::channel $BIN -c squaring --computation-size $1 mpc --port 8001 --peer-port 8000 --party 0 &> /dev/null &
pid0=$!
RUST_LOG=proof::mpc::channel $BIN -c squaring --computation-size $1 mpc --port 8000 --peer-port 8001 --party 1 &
